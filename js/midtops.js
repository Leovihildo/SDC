...
var midtopsHttp = new XMLHttpRequest();
midtopsHttp.open('GET', 'js/midtops.json', true);

midtopsHttp.onload = ()=>{
     // check if the connection is successful
     if (midtopsHttp.status == 200){
        let products = JSON.parse(midtopsHttp.responseText);
        ...
        document.querySelector(".mid-tops").innerHTML = output;
